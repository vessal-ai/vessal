...
Preset Skill of the compaction Cell. Hull instantiates one `Compaction` per project, configured with the main Cell's `frame_log.sqlite` path. Not for direct use in user agents.
